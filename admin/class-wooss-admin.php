	...
	public function field_for_request_shipments( $order ) {
		...
		if ( 'shop_order' == $post_type && $shipping_methods_enabled != "no" ) {
			...
			if ( 200 == $profile_data_response_code ) {
				...
				//MAKEING CHANGES HERE
				$country_code_default = $profile_data_response_body->country->code;
			}
			...
			$wooss_origin_country = $sendbox_data[ 'wooss_country' ];
			...
			if ( $method_id == 'wooss' ) {
				...
				<span>
					<span>
						...
						foreach ( $quotes_rates as $rates_id => $rates_values ) {
							...
							$currency = $rates_values->currency;
						...
						<select id="wooss_selected_courier" >
							...
							?>  
                             ...
                             <label><h4><b>ORIGIN NAME</b></h4></label>
						      <input class ="custom_input" required type="text" name="origin_name" placeholder="<?php esc_attr_e("Please Enter Origin Name")?>" id="origin_name" value=" " /> 

							  <label><h4><b>ORIGIN PHONE</b></h4></label>
						     <input class ="custom_input" required type="tel" name="origin_phone" placeholder="<?php esc_attr_e("Please Enter Origin Phone")?>" id="origin_phone" value=" " />

							

                                <label><h4><b>ORIGIN COUNTRY</b></h4></label>
                                <select class ="custom_input" id = "wooss_origin_country">
								<option data-country-code="default" value=""> 
								<?php _e( 'Please select origin country' ); ?>
								</option>
						...
						$states_api_url  = add_query_arg(
							array(
								'page_by'   => '{"per_page":10000}',
								'filter_by' => '{"country_code":"' . $country_code_default . '"}',
							),
							'https://api.sendbox.co/auth/states'
						);
						...
						?>
                            ...
                            <label><h4><b>ORIGIN STATE</b></h4></label>
                             <select class ="custom_input" id = "wooss_origin_states_selected">
							   <option data-state-code="default" value = ""> 
								<?php _e( 'Please select origin state' ); ?>
								</option>
						...
						<label><h4><b>ORIGIN STREET</b></h4></label>
						<input class ="custom_input" required type="text" name="origin_street" placeholder="<?php esc_attr_e("Please Enter Origin Street")?>" id="origin_street" value=" " /> 

						<label><h4><b>ORIGIN CITY</b></h4></label>
						<input class ="custom_input" required type="text" name="origin_city"  placeholder="<?php esc_html_e("Please Enter Origin City")?>" id="origin_city" value=" " />

						<?php //end of origin street?>
						<label><h4><b>DESTINATION COUNTRY</b></h4></label>
						...
						?>
						<label><h4><b>DESTINATION STATE</b></h4></label>
				...
				if ( $sendbox_data[ 'wooss_selected_country_code_used' ] ) {
					$country_code_default = $sendbox_data[ 'wooss_selected_country_code_used' ];
						...
						$city_api_url  = add_query_arg(
							...
							'https://api.sendbox.co/auth/cities'
						);
				...
				?>
					<!-- <input id= "wooss_destination_city_name" type="text" placeholder="Enter Destination City"  value="<?php //esc_html_e( $destination_city ); ?>"> -->
					    <label><h4><b>DESTINATION STREET</b></h4></label>
						<input placeholder="Please Enter Destination Street" class ="custom_input" required type="text" name="destination_street"  id="destination_street" value=" " /> 

						<label><h4><b>DESTINATION CITY</b></h4></label>
						<input class ="custom_input" placeholder="Please Enter Destination City"  required type="text" name="destination_city"  id="destination_city" value=" " />
