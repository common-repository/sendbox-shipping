  ...
  $(document).ready(function () {
    ...
    if (
      ...
      wooss_button_save.on("submit click", function (e) {
        e.preventDefault();
        var wooss_state_name = $("select[name='wooss[wooss_state_name]']").val();
        var wooss_username = $("input[name='wooss[wooss_username]']").val();
        var wooss_tel = $("input[name='wooss[wooss_tel]']").val();
        var wooss_email = $("input[name='wooss[wooss_email]']").val();
        var wooss_country = $("select.wooss_country_select").val();
        var wooss_city = $("input[name='wooss[wooss_city]']").val();
